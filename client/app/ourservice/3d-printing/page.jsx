...
{/* 3D printing solutions */}
      <div className="bg-gray-100 border-b-2">
       ...
       <div className="mx-auto py-4 max-w-5xl sm:text-center text-center p-2">
        ...
        <p className="ps-6 pt-1 mt-2 pb-6  container mx-auto text-2xl sm:text-2xl lg:leading-loose sm:leading-normal text-gray-700 font-medium tracking-wide">
          Our
...
cover rapid prototyping, detailed modeling, and more, providing efficient and precise printing solutions.
          ...
          <li className="ps-6 pb-4  container mx-auto text-base sm:text-md leading-loose text-neutral-800 font-normal tracking-wide">
