...
const features = [
  {
    name: "What We Offer",
    description:
      "In addition to crafting state-of-the-art laboratory setups, STEMTEC develops a wide range of cutting-edge products tailored to enrich STEM education. From educational kits and learning tools to specialized equipment and interactive resources, we aim to offer comprehensive solutions that bridge the gap between theory and practical application.",
  },
  {
    name: "How We Make a Difference",
    description:
      "Through a blend of expertise, creativity, and a commitment to excellence, STEMTEC develops products that align with educational objectives and cater to the evolving needs of educational institutions. By integrating the latest technologies, fostering collaborative partnerships, and emphasizing quality, we aim to enhance learning experiences and drive educational innovation.",
  },
];
      ...
      <div className="bg-white pt-14 sm:pt-12">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="p-8 sm:p-10 lg:flex-auto bg-gray-700">
            ...
            <p className="p-4 container mx-auto text-md sm:text-md leading-loose text-neutral-100 font-normal text-center tracking-widest">
              STEMTEC is more than an educational solutions provider,
              <span className="font-semibold">
                {" "}
                We&#39;re also a pioneering force in STEM product development.
              </span>{" "}
              Our team of dedicated professionals and experts collaborates
              tirelessly to design and manufacture innovative products that
              enhance the learning journey and laboratory experiences.
            </p>
          </div>
        ...
        <div className="bg-gray-700 mx-auto">
          ...
          <p className="py-6 container mx-auto text-md sm:text-md leading-loose text-neutral-100 font-normal text-center tracking-widest">
            Join us in our mission to transform education and product
            development in the STEM landscape.
            <br />
            Together, let&#39;s shape the future of learning and innovation,
            inspiring a generation of learners and innovators who will propel
            the world forward with their knowledge and discoveries.
          </p>
        </div>
      </div>
      <OurTeam />
