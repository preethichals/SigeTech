      ...
      <div className="mx-auto max-w-2xl rounded-3xl ring-1 ring-gray-200  lg:mx-0 lg:flex lg:max-w-none">
        <div className="p-8 sm:p-10 lg:flex-auto bg-gray-700">
          ...
          <p className=" max-w-6xl mt-6 text-base leading-7 text-gray-100 text-center mx-auto">
            At STEMTEC, we&#39;re passionate about revolutionizing education and
            creating innovative products that inspire curiosity and excellence
            in the fields of Science, Technology, Engineering, and Mathematics
            (STEM). We&#39;re committed to equipping educators, institutions,
            and students with cutting-edge tools and resources that nurture
            creativity, critical thinking, and hands-on learning experiences.{" "}
          </p>
        </div>
      </div>
          ...
          <div className="mx-auto max-w-2xl bg-white  rounded-3xl ring-1 ring-gray-200 lg:mx-0 lg:flex lg:max-w-none">
            <div className="p-8 sm:p-10 lg:flex-auto container">
              ...
              <p className="mt-6 text-base leading-7 text-gray-600">
                Our mission is twofold: to deliver unparalleled educational
                solutions and to design innovative products that elevate the
                learning experience. We&#39;re committed to ensuring that our
                products not only meet but exceed the standards of excellence,
                enabling educators and students to explore, experiment, and
